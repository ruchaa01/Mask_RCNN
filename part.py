...
class PartsDataset(utils.Dataset):

    def load_parts(self, dataset_dir, subset):
        """Load a subset of the Balloon dataset.
        dataset_dir: Root directory of the dataset.
        subset: Subset to load: train or val
        """
        # Add classes. We have only one class to add.
        self.add_class("parts", 1, "1")
        self.add_class("parts", 2, "2")
        self.add_class("parts", 3, "3")
        #self.add_class("parts", 4, "Ice_Cream")
        ...
        for a in annotations:
            ...
            class_ids = [int(n['Parts']) for n in objects]
...
def train(model):
    """Train the model."""
    # Training dataset.
    dataset_train = PartsDataset()
    dataset_train.load_parts(args.dataset, "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = PartsDataset()
    dataset_val.load_parts(args.dataset, "val")
    dataset_val.prepare()
...
if __name__ == '__main__':
    ...
    if args.command == "train":
        ...
        class InferenceConfig(PartsConfig):
